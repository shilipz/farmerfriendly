...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        body: BlocBuilder<QuantityButtonBloc, QuantityButtonState>(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          kwidth,
                          SalesContainer(saleText: state.count.toString()),
                          kwidth,
                          QuantityButton(
                              onpressed: () =>
                                  BlocProvider.of<QuantityButtonBloc>(context)
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              _addVegetableToFirestore(
                                  context, widget.vegetableName, selectedDay);
                            },
                            style: ButtonStyle(
                                backgroundColor:
  ...
  void _addVegetableToFirestore(
      BuildContext context, String vegetableName, DateTime selectedDay) async {
